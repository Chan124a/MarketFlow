...
Use this workflow when working on the Python quantitative analysis service or its NestJS integration. Keep quantitative logic in Python, keep TypeScript as the app/API integration layer, and preserve the local `mise` + `npm` + `uv` workflow.
